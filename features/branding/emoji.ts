...
//
// TODO: filled by scripts/create-tag-emoji.ts after upload. The values below
// are CLEARLY-MARKED PLACEHOLDER ids (the literal string "PLACEHOLDER"), NOT
// real Telegram custom_emoji_ids. The renderer (features/render/prefix.ts) MUST
// treat any pill whose ids are placeholders as "no real ids" and fall back to
// the unicode TAG_PILL_FALLBACK badge - a placeholder must NEVER go out inside a
// <tg-emoji> tag (Telegram would reject it / show a broken emoji).
//
...
export const TAG_PILL_IDS: Record<string, string[]> = {
  ANSWER: [TAG_PILL_PLACEHOLDER, TAG_PILL_PLACEHOLDER],                          // answer_0, answer_1
  DECISION: [TAG_PILL_PLACEHOLDER, TAG_PILL_PLACEHOLDER, TAG_PILL_PLACEHOLDER],  // decision_0..2
  PROBLEM: [TAG_PILL_PLACEHOLDER, TAG_PILL_PLACEHOLDER, TAG_PILL_PLACEHOLDER],   // problem_0..2
  REPORT: [TAG_PILL_PLACEHOLDER, TAG_PILL_PLACEHOLDER],                          // report_0, report_1
}
