...
export type Action =
  ...
  // carries the quote anchor (items 2,3); it is injected verbatim. messageId
  // here is the REPLY message's own id (not replyToMessageId) — the reaction
  // target when the routed text is deferred and later flushed.
